...
type Project struct {
	...
	TeamID TeamID //mgo:relation belongsTo=Team
	//mgo:sql filter
	OwnerID  UserID //mgo:relation belongsTo=User
	Name     string //mgo:sql filter sort
...
type Post struct {
	...
	//mgo:sql filter sort
	ProjectID ProjectID //mgo:relation belongsTo=Project
	//mgo:sql filter
	UserID    UserID //mgo:relation belongsTo=User
...
type Comment struct {
	...
	//mgo:sql filter sort
	PostID PostID //mgo:relation belongsTo=Post
	//mgo:sql filter
	UserID   UserID     //mgo:relation belongsTo=User
