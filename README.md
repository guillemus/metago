...
With Go 1.24 or later, you can pin Metago as a project tool and run it through `go generate`:
...
See [`std/serde`](std/serde/) for implementation notes, compatibility policy, reliability tests,
